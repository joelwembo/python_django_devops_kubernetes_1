...
# from apps.users.views import UserViewSet, RegistrationView, LoginView, LogoutView, ChangePasswordView
...
# router.register(r'router/users', UserViewSet, basename="users")
# router.register(r'router/auth/register', users_urls.RegistrationView, basename="register")
# router.register(r'router/auth/login', users_urls.LoginView, basename="login")
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        contact=openapi.Contact(email="info@prodxcloud.com"),
